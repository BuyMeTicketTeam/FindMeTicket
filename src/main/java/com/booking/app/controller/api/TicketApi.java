...
public interface TicketApi {
    ...
    ResponseBodyEmitter getTicketById(@PathVariable String id, @RequestHeader(HttpHeaders.CONTENT_LANGUAGE) String siteLanguage, HttpServletResponse response) throws IOException, ParseException;
