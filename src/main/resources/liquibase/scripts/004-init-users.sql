INSERT INTO find_me_ticket_schema.user (id, email, password, username, providers, roles,
                                        expired, locked, credentials_expired, enabled,
                                        registration_date, social_media_avatar, notification)
VALUES ('282cd4b3-240c-4483-811c-3625e1795626',
        'max@gmail.com',
        '$2a$12$baLyrG5ATzSBqUnaOidMgua1GXuYNDAg6JdaLA/DgFrBO5hiheu1S',
        'Max',
        ARRAY ['GOOGLE']::auth_provider[],
        ARRAY ['ADMIN']::role[],
        TRUE, TRUE, TRUE, TRUE,
        NOW(),
