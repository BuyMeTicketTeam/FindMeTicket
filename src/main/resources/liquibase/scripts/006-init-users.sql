INSERT INTO find_me_ticket_schema.user (id, email, password, username,
                                         account_non_expired, account_non_locked, credentials_non_expired,
                                         enabled, registration_date, social_media_avatar, notification)
VALUES ('282cd4b3-240c-4483-811c-3625e1795626',
        'max@gmail.com',
        '$2a$12$baLyrG5ATzSBqUnaOidMgua1GXuYNDAg6JdaLA/DgFrBO5hiheu1S',
        'Max',
        TRUE, TRUE, TRUE, TRUE,
        NOW(),
...
INSERT INTO find_me_ticket_schema.user_role (user_id, role_id)
...
INSERT INTO find_me_ticket_schema.user_provider (user_id, provider_id)
VALUES ('282cd4b3-240c-4483-811c-3625e1795626', 1),
       ('6bdafe1f-fb85-4d04-b95a-532570a2d8fb', 1),
       ('c7a4efb5-1525-4f6a-9672-2b865f414de3', 1),
       ('1523babf-4ede-4a3f-9920-9795c228091b', 1);
