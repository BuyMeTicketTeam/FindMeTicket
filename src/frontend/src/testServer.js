...
const tickets = [
  {
    ...
    arrivalCity: 'Київ',
    placeFrom: 'Автовокзал "Центральний" sdfdsfsdf sd fdsf sdfsdfsdfsdf sd fsd fsd f',
    placeAt: 'Южный автовокзал dafafdasda sd asd asd as da dsas das as  as dsdasdasdasd',
    price: '4000',
