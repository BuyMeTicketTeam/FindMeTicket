...
function Popup({ updateAuthValue, status }) {
  ...
  function handleDeleteButton() {
    makeQuerry("delete-user", undefined, undefined, "DELETE").then(
      (response) => {
        switch (response.status) {
          case 200:
            navigate("/");
  ...
  async function getHistory() {
    setLoading(true);
    const response = await makeQuerry(
      "getHistory",
      undefined,
      undefined,
      "GET"
  ...
  function defineRoute(historyData) {
    ...
    if (
      ...
      request += `&departureDate=${Date.parse(
  ...
  if (!status) {
    navigate("/login", {
      state: { successNavigate: "/profile-page", closeNavigate: "/" },
    });
    return <p>redirect</p>;
  }
    ...
    <div className="popup-content main">
      <div className="centered-block">
        ...
        >
          ...
          <img
            src={
              ...
              (status.basicPicture
                ? `data:image/jpeg;base64,${status.basicPicture}`
                : Ellipse)
            }
            alt="Avatar"
        ...
        <p className="username">
          {t("hello")} {status.username} <div className="Lvl">Lvl 1</div>
          <div
        ...
        >
          <img src={Frame} alt="Exit" className="exit-icon" />
        </button>
      ...
      <div className="notification-wrapper">
        <p className="notification-text">{t("notice")}</p>
        ...
        <div className="contact-item">
          <div className="column">
            ...
            <div className="contact-info-data">
              <div className="email-data">{status.email}</div>
            </div>
          </div>
          <div className="column">
            <div className="column-header">
          ...
          <div className="column">
            <div className="column-header">
              ...
              <p className="contact-info-two actions-info">
      ...
      >
        ...
        <div
          className={`history-arrow ${isHistoryExpanded ? "arrow-down" : ""}`}
        />
      </div>
      {isHistoryExpanded && (
            ...
            history.map((historyItem) => (
              ...
              >
                ...
                <div className="history-central-column">
                  <div className="history-departure-date">
