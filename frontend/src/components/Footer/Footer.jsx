            ...
            {isFooterVisible && (
              <div className="carousel-wrapper">
                ...
                >
                  ...
                  <div className="footer-column">
                    <Link
                      to={`/?&type=all&from=${t("Dnipro")}&to=${t(
                        "Chernivtsi"
                      )}&endpoint=1`}
                      className="rectangle"
                    >
                  ...
                  <div className="footer-column">
                    <Link
                      to={`/?&type=all&from=${t("Kharkiv")}&to=${t(
                        "IvanoFrankivsk"
                      )}&endpoint=1`}
                      className="rectangle"
                    >
                  ...
                  <div className="footer-column">
                    <Link
                      to={`/?&type=all&from=${t("Odessa")}&to=${t(
                        "Kherson"
                      )}&endpoint=1`}
                      className="rectangle"
                    >
                  ...
                  <div className="footer-column">
                    <Link
                      to={`/?&type=all&from=${t("Zaporizhzhya")}&to=${t(
                        "Krivyi Rih"
                      )}&endpoint=1`}
                      className="rectangle"
                    >
                  ...
                  <div className="footer-column">
                    <Link
                      to={`/?&type=all&from=${t("Vinnytsya")}&to=${t(
                        "Lviv"
                      )}&endpoint=1`}
                      className="rectangle"
                    >
