    ...
    <div className="train-price ticket-price">
      <div className="ticket-header">
        {ticketUrls.some((url) => url.event === "proizdua") && (
          <button
            className={`ticket-header__btn ${
              selctedResource === 0 ? "active" : ""
            }`}
            type="button"
            onClick={() => setSelectedResource(0)}
          >
        ...
        {ticketUrls.some((url) => url.event === "ticketsua") && (
          <button
            className={`ticket-header__btn ${
              selctedResource === 1 ? "active" : ""
            }`}
            type="button"
            onClick={() => setSelectedResource(1)}
          >
